                ...
                <div className="flex flex-col lg:flex-row justify-between">
                    ...
                    <div className="flex h-[50px] items-center gap-2 lg:gap-4 mb-4 lg:my-0">
                        <div className="flex flex-col gap-1 lg:items-end">
                            ...
                            <span className="text-xs sm:text-base text-gray">
                                Sunnyavle, Ca
                            </span>
                        </div>
                        <div className="bg-white rounded-xl h-[40px] w-[40px] lg:h-[50px] lg:w-[50px] flex items-center justify-center">
                            ...
                            >
                                <g clipPath="url(#clip0_1_425)">
                                    ...
                                    />
                                    <path
                                        d="M37.1709 14.7491C36.1922 15.658 34.8933 16.1422 33.5585 16.0958C32.2237 16.0494 30.9616 15.4762 30.0484 14.5016C28.0427 12.3829 25.2775 11.1477 22.361 11.0677C19.4446 10.9878 16.6159 12.0697 14.4971 14.0754C12.3784 16.0811 11.1432 18.8463 11.0632 21.7627C10.9833 24.6791 12.0652 27.5079 14.0709 29.6266C13.4613 29.0034 12.7006 28.5489 11.8629 28.3074C11.0253 28.066 10.1393 28.0458 9.29158 28.249C8.44383 28.4522 7.66324 28.8717 7.02602 29.4666C6.3888 30.0615 5.91672 30.8115 5.65587 31.6433C2.98125 28.3752 1.35792 24.3744 0.999207 20.1666C1.35465 16.0852 2.89151 12.1958 5.42189 8.97383C7.95228 5.75185 11.3666 3.33689 15.2474 2.02416C19.1282 0.711424 23.3074 0.557801 27.2742 1.58207C31.2409 2.60633 34.8233 4.7641 37.5834 7.79161C38.428 8.77941 38.857 10.0561 38.78 11.3535C38.7031 12.6509 38.1263 13.868 37.1709 14.7491Z"
                                        fill="#82BCF4"
                                    />
                                    <path
                ...
                <div className="flex flex-col lg:flex-row gap-4 xl:gap-0 lg:justify-between mt-6">
                    <div className="flex gap-4 items-center flex-wrap">
                        <div className="flex">
                            ...
                            <div className="bg-gray rounded-full w-8 h-8 xl:w-10 xl:h-10 border-2 border-light-purple -ml-2"></div>
                            <div className="bg-gray rounded-full w-8 h-8 xl:w-10 xl:h-10 border-2 border-light-purple -ml-2 "></div>
                            <div className="bg-gray rounded-full w-8 h-8 xl:w-10 xl:h-10 border-2 border-light-purple -ml-2"></div>
                            <div className="bg-pink rounded-full w-8 h-8 xl:w-10 xl:h-10 border-2 border-light-purple text-white -ml-2 flex items-center justify-center">
                                <span className="">5+</span>
                            </div>
                        </div>
                        <button className="bg-violet flex gap-2 items-center p-2 rounded-xl px-4 text-xs md:text-base">
                            <FiUserPlus fill="white" className="md:text-xl" />{" "}
                            Invite People
                        </button>
                        <button className="bg-black border-2 border-iris flex gap-2 items-center p-2 rounded-xl px-4 text-xs md:text-base">
                            Private
                        </button>
                        <button className="bg-iris text-white flex gap-2 items-center p-2 rounded-xl px-4 text-xs md:text-base">
                            Edit
                        </button>
                        <button className="bg-black border-2 border-iris flex gap-2 items-center p-2 rounded-xl px-4 text-xs md:text-base">
                    ...
                    <div className="flex flex-col md:flex-row gap-4 items-center mt-6 md:mt-0 ">
                        ...
                        <div className="loading-bar relative w-[200px] h-2 bg-dark-purple rounded-md before:content-[''] before:absolute before:bg-violet before:w-1/2 before:h-full before:rounded-md"></div>
                    </div>
                </div>
            </div>
        </div>
